      ...
      <div className="flex-1 bg-gradient-to-br from-sky-400 via-blue-500 to-indigo-600 flex flex-col justify-between p-8 md:p-16 text-white relative overflow-hidden min-h-[300px] md:min-h-screen">
        ...
        <div className="my-auto max-w-lg z-10">
          <h1 className="text-[36px] md:text-[48px] font-extrabold leading-tight tracking-tight mb-6">
            Join the future of financial freedom.
          </h1>
          <p className="text-[15px] md:text-[16px] text-sky-100 font-medium leading-relaxed">
            Create an account in less than a minute to explore intelligent automated budget planning, goal setting, and insightful financial metrics.
          </p>
        </div>
            ...
            {isClerkActive ? (
              ...
              <div className="w-full animate-fade-in-up">
                <div className="mb-8 text-center md:text-left">
                  <h2 className="text-slate-900 font-bold text-[28px] tracking-tight">Create your account</h2>
                  <p className="text-slate-400 font-medium text-[14px] mt-1">Get started with Finova AI today</p>
                </div>
                ...
                <form onSubmit={handleMockSignUp} className="space-y-5">
                  ...
                  <div>
                    <label className="text-[12px] font-bold text-slate-600 mb-1.5 block">Password</label>
                    <input
                      type="password"
                      required
